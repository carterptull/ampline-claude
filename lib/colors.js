...
// Haiku is a single-color model family, so it has no gradient table. It is
// treated as a special case in colorForModelEffort() and is not included in
// MODEL_GRADIENTS.
const HAIKU_COLOR = [125, 184, 232];
// Neutral grey — used when normalizeModelFamily can't place the model in
// Haiku/Sonnet/Opus/Fable (a future or renamed model)
